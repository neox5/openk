...
// Error represents a standard error response following RFC 7807
type Error struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// Type is a URI reference identifying the error category
	Type string `protobuf:"bytes,1,opt,name=type,proto3" json:"type,omitempty"`
	// Title is a short, human-readable summary
	Title string `protobuf:"bytes,2,opt,name=title,proto3" json:"title,omitempty"`
	// Status is the HTTP status code
	Status int32 `protobuf:"varint,3,opt,name=status,proto3" json:"status,omitempty"`
	// Detail provides specific error explanation
	Detail string `protobuf:"bytes,4,opt,name=detail,proto3" json:"detail,omitempty"`
	// Instance is a URI reference to error occurrence
	Instance string `protobuf:"bytes,5,opt,name=instance,proto3" json:"instance,omitempty"`
	// Extensions contains additional context as JSON
	Extensions string `protobuf:"bytes,6,opt,name=extensions,proto3" json:"extensions,omitempty"`
}
...
func (x *Error) GetExtensions() string {
	if x != nil {
		return x.Extensions
	}
	return ""
...
// Metadata represents key-value pairs for request context
...
// Range represents a time range with start and end
...
var file_api_v1_common_proto_rawDesc = []byte{
	...
	0x01, 0x0a, 0x05, 0x45, 0x72, 0x72, 0x6f, 0x72, 0x12, 0x12, 0x0a, 0x04, 0x74, 0x79, 0x70, 0x65,
	...
	,
	...
	0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0x6b, 0x0a, 0x09, 0x54,
	...
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2e, 0x54, 0x69, 0x6d, 0x65, 0x73, 0x74,
	0x61, 0x6d, 0x70, 0x52, 0x03, 0x65, 0x6e, 0x64, 0x42, 0x75, 0x0a, 0x0a, 0x63, 0x6f, 0x6d, 0x2e,
	...
	0x6d, 0x2f, 0x6e, 0x65, 0x6f, 0x78, 0x35, 0x2f, 0x6f, 0x70, 0x65, 0x6e, 0x6b, 0x2f, 0x61, 0x70,
	0x69, 0x2f, 0x76, 0x31, 0x2f, 0x67, 0x65, 0x6e, 0xa2, 0x02, 0x03, 0x41, 0x58, 0x58, 0xaa, 0x02,
...
var file_api_v1_common_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_api_v1_common_proto_goTypes = []interface{}{
	(*Error)(nil),                 // 0: api.v1.Error
	(*Metadata)(nil),              // 1: api.v1.Metadata
	(*TimeRange)(nil),             // 2: api.v1.TimeRange
	nil,                           // 3: api.v1.Metadata.FieldsEntry
	(*timestamppb.Timestamp)(nil), // 4: google.protobuf.Timestamp
}
var file_api_v1_common_proto_depIdxs = []int32{
	3, // 0: api.v1.Metadata.fields:type_name -> api.v1.Metadata.FieldsEntry
	4, // 1: api.v1.TimeRange.start:type_name -> google.protobuf.Timestamp
	4, // 2: api.v1.TimeRange.end:type_name -> google.protobuf.Timestamp
